        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $htmlContent = '
                    <div id="sthiti" style="font-size:13px;background-color:brown;" class="table text-white text-center">' . $name . ' यांच्या प्रस्तावाची सद्यस्थिती <br><p style="font-size:20px;background-color:brown;" class="table text-white text-center" > '. $patra_apatra. ' </p></div>
                    <table class="table">
