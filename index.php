        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $htmlContent = '
                    <div id="sthiti" style="font-size:18px;background-color:rgb(102 16 242);" class="table text-white text-center">' . $name . ' यांच्या प्रस्तावाची सद्यस्थिती <br><p style="font-size:25px;background-color:brown;" class="table text-white text-center" > '. $patra_apatra. ' </p></div>
                    <table class="table">
...
<body class="container">
    <div class="col-12 top-0 start-0 z-1">
     ...
     <p id="intro" class="col-12" style="margin-top:10px;width:90%;margin-left:20px;">नमस्कार, मी प्रकल्प अधिकारी, एकात्मिक आदिवासी विकास प्रकल्प, पुसद जि.यवतमाळ  आपले चॅटबॉट मध्ये स्वागत करत आहे.</p>
     <p id="prastavsthiti" class="col-12" style="width:90%;margin-left:20px;">२. तुमच्या प्रस्तावाची सद्यस्थिती तपासा</p>
