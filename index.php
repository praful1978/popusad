        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $htmlContent = '
                    <div id="sthiti"><p style="font-size:13px;background-color:brown;" class="table text-white text-center" >' . $name . ' यांच्या प्रस्तावाची सद्यस्थिती </p><br><p style="font-size:20px;background-color:brown;" class="table text-white text-center" > '. $patra_apatra. ' </p></div>
                    <table class="table">
...
<body class="container-fluid">
    ...
    <div id="div1" class="col-12 z-0">
        <p id="intro" class="col-12">नमस्कार, मी प्रकल्प अधिकारी, एकात्मिक आदिवासी विकास प्रकल्प, पुसद जि.यवतमाळ आपले चॅटबूट मध्ये स्वागत करत आहे.</p>
