        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $htmlContent = '
                    <div id="sthiti" style="font-size:18px;" class="table text-center bg-info">' . $name . ' यांच्या प्रस्तावाची सद्यस्थिती <br><p style="font-size:25px;color:black;" class="table text-center bg-info" > '. $patra_apatra. ' </p></div>
                    <table class="table">
