        ...
        if ($stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $htmlContent = '
                    <div id="sthiti" style="font-size:18px;width:90%;margin-left:20px;" class="table text-center">' . $name . ' यांच्या प्रस्तावाची सद्यस्थिती <br><p style="font-size:25px;color:black;width:90%;margin-left:20px;" class="table text-center bg-info" > '. $patra_apatra. ' </p></div>
                    <table class="table">
